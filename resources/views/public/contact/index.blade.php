...
<section class="d-flex align-items-center bg-white" style="min-height: 220px;">
    <div class="container text-center">
        <h1 class="fw-bold display-6 mb-2" style="color: #183D6A;">Contactez-nous</h1>
        <p class="mb-0" style="color: #183D6A; max-width: 500px; margin: 0 auto;">Une question, une suggestion ? Nous sommes à votre écoute.</p>
    </div>
</section>
            ...
            <div class="col-lg-7">
                ...
                <div class="card border-0 shadow rounded-3">
                    <div class="card-body p-4 p-md-5">
                        <h4 class="fw-bold mb-1" style="color: #183D6A ;">Envoyez-nous un message</h4>
                        <hr class="my-3" style="width: 60px; height: 3px; border: none; background-color: #98732B; opacity: 1;">
                        <form action="{{ route('public.contact.store') }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-lg w-100 fw-semibold py-3 text-white border-0" style="background-color: #98732B; hover: background-color: #183D6A;">
            ...
            <div class="col-lg-5">
                <div class="card border-0 shadow rounded-3 h-100">
                    <div class="card-body p-4 p-md-5 d-flex flex-column">
                        <h5 class="fw-bold mb-1" style="color: #183D6A;">Informations</h5>
                        <hr class="my-3" style="width: 40px; height: 3px; border: none; background-color: #98732B; opacity: 1;">

                        <div class="d-flex align-items-start gap-3 mb-3">
                            <div class="d-flex align-items-center justify-content-center rounded-circle flex-shrink-0" style="width: 44px; height: 44px; background-color: rgba(152,115,43,0.12);">
                                <i class="bi bi-telephone-fill" style="color: #98732B;"></i>
                            </div>
                            <div>
                                <small class="text-muted">Téléphone</small>
                                <p class="mb-0 fw-medium" style="color: #183D6A;">+229 01 66 16 75 88</p>
                            </div>
                        </div>

                        <div class="d-flex align-items-start gap-3 mb-3">
                            <div class="d-flex align-items-center justify-content-center rounded-circle flex-shrink-0" style="width: 44px; height: 44px; background-color: rgba(152,115,43,0.12);">
                                <i class="bi bi-envelope-fill" style="color: #98732B;"></i>
                            </div>
                            <div>
                                <small class="text-muted">E-mail</small>
                                <p class="mb-0 fw-medium" style="color: #183D6A;">eyissobur@gmail.com</p>
                            </div>
                        </div>

                        <div class="d-flex align-items-start gap-3 mb-4">
                            <div class="d-flex align-items-center justify-content-center rounded-circle flex-shrink-0" style="width: 44px; height: 44px; background-color: rgba(152,115,43,0.12);">
                                <i class="bi bi-geo-alt-fill" style="color: #98732B;"></i>
                            </div>
                            <div>
                                <small class="text-muted">Adresse</small>
                                <p class="mb-0 fw-medium" style="color: #183D6A;">Porto-Novo, Bénin</p>
                            </div>
                        </div>

                        <hr class="my-4">

                        <h6 class="fw-semibold mb-3" style="color: #183D6A;">Suivez-nous</h6>
                        <div class="d-flex flex-wrap gap-3">
                            <a href="#" class="d-flex align-items-center gap-2 text-decoration-none" style="color: #183D6A;">
                                <i class="bi bi-facebook fs-5" style="color: #98732B;"></i>
                                <span class="small fw-medium">Facebook</span>
                            </a>
                            <a href="#" class="d-flex align-items-center gap-2 text-decoration-none" style="color: #183D6A;">
                                <i class="bi bi-instagram fs-5" style="color: #98732B;"></i>
                                <span class="small fw-medium">Instagram</span>
                            </a>
                            <a href="#" class="d-flex align-items-center gap-2 text-decoration-none" style="color: #183D6A;">
                                <i class="bi bi-youtube fs-5" style="color: #98732B;"></i>
                                <span class="small fw-medium">YouTube</span>
                            </a>
                            <a href="#" class="d-flex align-items-center gap-2 text-decoration-none" style="color: #183D6A;">
                                <i class="bi bi-tiktok fs-5" style="color: #98732B;"></i>
                        ...
                        <h6 class="fw-semibold mb-3" style="color: #183D6A;">Retrouvez-nous</h6>
                        ...
                        <a href="https://maps.google.com/?q=Porto-Novo+B%C3%A9nin" target="_blank" rel="noopener" class="btn btn-outline-secondary w-100 d-flex align-items-center justify-content-center gap-2 py-2">
                            <i class="bi bi-box-arrow-up-right" style="color: #98732B;"></i>
...
<section class="py-5 text-center bg-white">
    <div class="container">
        <h3 class="fw-bold mb-2" style="color: #183D6A;">Vous souhaitez soutenir le FITAB ?</h3>
        <p class="text-muted mb-4">Devenez partenaire ou sponsor du Festival International des Talents Artistiques du Bénin.</p>
        <a href="#formulaire" class="btn btn-lg fw-semibold px-5 py-3 text-white border-0" style="background-color: #98732B;">
